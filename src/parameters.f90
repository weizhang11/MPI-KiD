...
module parameters
...
#ifdef USE_MPI
  integer            :: nx           ! Number of horizontal gridpoints
  integer, parameter :: pnx=DEF_NX   ! Number of horizontal gridpoints
#else
  integer, parameter :: nx=DEF_NX    ! Number of horizontal gridpoints
  integer            :: pnx          ! Number of horizontal gridpoints
#endif
...
#if SHIPWAY_MICRO == 1
  integer, parameter :: naerosol=12 ! number of aerosol species
#else
 ...
 ! other parameters
  ...
  character(15) :: aero_names(naerosol)= & 
     (/ 'aitken         '   & 
     ,  'accum          '   & 
     ,  'coarse         '   &
#if SHIPWAY_MICRO == 1
