...
#else
#ifdef USE_MPI
      call KiD_thompson_k_decomp(ntb_r*ntb_r1,km_s,km_e)
#else
      km_s = 0
      km_e = ntb_r*ntb_r1 - 1
#endif
...
#else
#ifdef USE_MPI
      call comm_gatherv_dp(tcg_racg,ntb_g*ntb_g1,km_s,km_e)
      call comm_gatherv_dp(tmr_racg,ntb_g*ntb_g1,km_s,km_e)
      call comm_gatherv_dp(tcr_gacr,ntb_g*ntb_g1,km_s,km_e)
      call comm_gatherv_dp(tmg_gacr,ntb_g*ntb_g1,km_s,km_e)
      call comm_gatherv_dp(tnr_racg,ntb_g*ntb_g1,km_s,km_e)
      call comm_gatherv_dp(tnr_gacr,ntb_g*ntb_g1,km_s,km_e)
#endif
#endif
...
#else
#ifdef USE_MPI
      CALL comm_gatherv_dp(tcs_racs1, ntb_s*ntb_t, km_s, km_e)
      CALL comm_gatherv_dp(tmr_racs1, ntb_s*ntb_t, km_s, km_e)
      CALL comm_gatherv_dp(tcs_racs2, ntb_s*ntb_t, km_s, km_e)
      CALL comm_gatherv_dp(tmr_racs2, ntb_s*ntb_t, km_s, km_e)
      CALL comm_gatherv_dp(tcr_sacr1, ntb_s*ntb_t, km_s, km_e)
      CALL comm_gatherv_dp(tms_sacr1, ntb_s*ntb_t, km_s, km_e)
      CALL comm_gatherv_dp(tcr_sacr2, ntb_s*ntb_t, km_s, km_e)
      CALL comm_gatherv_dp(tms_sacr2, ntb_s*ntb_t, km_s, km_e)
      CALL comm_gatherv_dp(tnr_racs1, ntb_s*ntb_t, km_s, km_e)
      CALL comm_gatherv_dp(tnr_racs2, ntb_s*ntb_t, km_s, km_e)
      CALL comm_gatherv_dp(tnr_sacr1, ntb_s*ntb_t, km_s, km_e)
      CALL comm_gatherv_dp(tnr_sacr2, ntb_s*ntb_t, km_s, km_e)
#endif
#endif
